...
func main() {
	...
	var RootCmd = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			cm.AddWritableStep(upgradestatus.CHECK_MASTER, idl.UpgradeSteps_CHECK_MASTER)
			cm.AddWritableStep(upgradestatus.CHECK_PRIMARIES, idl.UpgradeSteps_CHECK_PRIMARIES)
			cm.AddWritableStep(upgradestatus.RESTART_TARGET_CLUSTER, idl.UpgradeSteps_RESTART_TARGET_CLUSTER)
