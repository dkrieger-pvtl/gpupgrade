...
var lines = map[idl.Substep]string{
	...
	idl.Substep_FINALIZE_UPDATE_TARGET_CATALOG_WITH_DATADIRS: "Updating new cluster data directories in the database...",
	idl.Substep_FINALIZE_UPDATE_SOURCE_CATALOG_WITH_DATADIRS: "Renaming old cluster data directories in the database...",
	idl.Substep_FINALIZE_RENAME_TARGET_MASTER_DATADIR:        "Renaming new cluster master data directory...",
	idl.Substep_FINALIZE_RENAME_TARGET_SEG_DATADIRS:          "Renaming new cluster segment data directories...",
	idl.Substep_FINALIZE_RENAME_SOURCE_MASTER_DATADIR:        "Renaming old cluster master data directory...",
	idl.Substep_FINALIZE_RENAME_SOURCE_SEG_DATADIRS:          "Renaming old cluster segment data directories...",
	idl.Substep_FINALIZE_UPDATE_GPPERFMON_CONF:               "Updating old and new master's gpperfmon.conf...",
