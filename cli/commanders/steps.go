...
var lines = map[idl.Substep]string{
	...
	idl.Substep_FINALIZE_UPDATE_CATALOG:          "Updating new master with port information...",
	...
	idl.Substep_FINALIZE_SWAP_DATA_DIRECTORIES:   "Installing upgraded data directories...",
}
