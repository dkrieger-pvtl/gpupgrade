...
type RsyncDataDirPair struct {
	Src                  string   `protobuf:"bytes,1,opt,name=src,proto3" json:"src,omitempty"`
	DstHostname          string   `protobuf:"bytes,2,opt,name=dst_hostname,json=dstHostname,proto3" json:"dst_hostname,omitempty"`
...
func (m *RsyncDataDirPair) Reset()         { *m = RsyncDataDirPair{} }
func (m *RsyncDataDirPair) String() string { return proto.CompactTextString(m) }
func (*RsyncDataDirPair) ProtoMessage()    {}
func (*RsyncDataDirPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_9e73bb06acc917d8, []int{16}
}

func (m *RsyncDataDirPair) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RsyncDataDirPair.Unmarshal(m, b)
}
func (m *RsyncDataDirPair) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RsyncDataDirPair.Marshal(b, m, deterministic)
}
func (m *RsyncDataDirPair) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsyncDataDirPair.Merge(m, src)
}
func (m *RsyncDataDirPair) XXX_Size() int {
	return xxx_messageInfo_RsyncDataDirPair.Size(m)
}
func (m *RsyncDataDirPair) XXX_DiscardUnknown() {
	xxx_messageInfo_RsyncDataDirPair.DiscardUnknown(m)
}

var xxx_messageInfo_RsyncDataDirPair proto.InternalMessageInfo

func (m *RsyncDataDirPair) GetSrc() string {
	if m != nil {
		return m.Src
	}
	return ""
...
func (m *RsyncDataDirPair) GetDstHostname() string {
	if m != nil {
		return m.DstHostname
	}
	return ""
}

func (m *RsyncDataDirPair) GetDst() string {
	if m != nil {
		return m.Dst
	}
	return ""
...
type RsyncDataDirectoryRequest struct {
	...
	Pairs                []*RsyncDataDirPair `protobuf:"bytes,3,rep,name=pairs,proto3" json:"pairs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}

func (m *RsyncDataDirectoryRequest) Reset()         { *m = RsyncDataDirectoryRequest{} }
func (m *RsyncDataDirectoryRequest) String() string { return proto.CompactTextString(m) }
func (*RsyncDataDirectoryRequest) ProtoMessage()    {}
func (*RsyncDataDirectoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9e73bb06acc917d8, []int{17}
}

func (m *RsyncDataDirectoryRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RsyncDataDirectoryRequest.Unmarshal(m, b)
}
func (m *RsyncDataDirectoryRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RsyncDataDirectoryRequest.Marshal(b, m, deterministic)
}
func (m *RsyncDataDirectoryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsyncDataDirectoryRequest.Merge(m, src)
}
func (m *RsyncDataDirectoryRequest) XXX_Size() int {
	return xxx_messageInfo_RsyncDataDirectoryRequest.Size(m)
}
func (m *RsyncDataDirectoryRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RsyncDataDirectoryRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RsyncDataDirectoryRequest proto.InternalMessageInfo

func (m *RsyncDataDirectoryRequest) GetOptions() []string {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *RsyncDataDirectoryRequest) GetExclude() []string {
	if m != nil {
		return m.Exclude
	}
	return nil
...
func (m *RsyncDataDirectoryRequest) GetPairs() []*RsyncDataDirPair {
	if m != nil {
		return m.Pairs
	}
	return nil
...
type RsyncDataDirectoryReply struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *RsyncDataDirectoryReply) Reset()         { *m = RsyncDataDirectoryReply{} }
func (m *RsyncDataDirectoryReply) String() string { return proto.CompactTextString(m) }
func (*RsyncDataDirectoryReply) ProtoMessage()    {}
func (*RsyncDataDirectoryReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_9e73bb06acc917d8, []int{18}
}

func (m *RsyncDataDirectoryReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RsyncDataDirectoryReply.Unmarshal(m, b)
}
func (m *RsyncDataDirectoryReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RsyncDataDirectoryReply.Marshal(b, m, deterministic)
}
func (m *RsyncDataDirectoryReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RsyncDataDirectoryReply.Merge(m, src)
}
func (m *RsyncDataDirectoryReply) XXX_Size() int {
	return xxx_messageInfo_RsyncDataDirectoryReply.Size(m)
}
func (m *RsyncDataDirectoryReply) XXX_DiscardUnknown() {
	xxx_messageInfo_RsyncDataDirectoryReply.DiscardUnknown(m)
}

var xxx_messageInfo_RsyncDataDirectoryReply proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*RsyncDataDirPair)(nil), "idl.RsyncDataDirPair")
	proto.RegisterType((*RsyncDataDirectoryRequest)(nil), "idl.RsyncDataDirectoryRequest")
	proto.RegisterType((*RsyncDataDirectoryReply)(nil), "idl.RsyncDataDirectoryReply")
}
...
var fileDescriptor_9e73bb06acc917d8 = []byte{
	...
	,
}
...
type AgentClient interface {
	...
	RsyncDataDirectory(ctx context.Context, in *RsyncDataDirectoryRequest, opts ...grpc.CallOption) (*RsyncDataDirectoryReply, error)
}
...
func (c *agentClient) RsyncDataDirectory(ctx context.Context, in *RsyncDataDirectoryRequest, opts ...grpc.CallOption) (*RsyncDataDirectoryReply, error) {
	out := new(RsyncDataDirectoryReply)
	err := c.cc.Invoke(ctx, "/idl.Agent/RsyncDataDirectory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServer interface {
	...
	RsyncDataDirectory(context.Context, *RsyncDataDirectoryRequest) (*RsyncDataDirectoryReply, error)
}
...
func (*UnimplementedAgentServer) RsyncDataDirectory(ctx context.Context, req *RsyncDataDirectoryRequest) (*RsyncDataDirectoryReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RsyncDataDirectory not implemented")
}
...
func _Agent_RsyncDataDirectory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RsyncDataDirectoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServer).RsyncDataDirectory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/idl.Agent/RsyncDataDirectory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServer).RsyncDataDirectory(ctx, req.(*RsyncDataDirectoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Agent_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RsyncDataDirectory",
			Handler:    _Agent_RsyncDataDirectory_Handler,
		},
	},
