...
const (
	...
	Substep_RESTORE_SOURCE_MASTER_AND_PRIMARIES      Substep = 28
...
var Substep_name = map[int32]string{
	...
	28: "RESTORE_SOURCE_MASTER_AND_PRIMARIES",
...
var Substep_value = map[string]int32{
	...
	"RESTORE_SOURCE_MASTER_AND_PRIMARIES":      28,
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
