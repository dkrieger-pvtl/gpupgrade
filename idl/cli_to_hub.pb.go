...
const (
	...
	UpgradeSteps_START_SOURCE_CLUSTER    UpgradeSteps = 9
	UpgradeSteps_UPGRADE_MASTER          UpgradeSteps = 10
	UpgradeSteps_COPY_MASTER             UpgradeSteps = 11
	UpgradeSteps_UPGRADE_PRIMARIES       UpgradeSteps = 12
	UpgradeSteps_START_TARGET_CLUSTER    UpgradeSteps = 13
	UpgradeSteps_RECONFIGURE_PORTS       UpgradeSteps = 14
)
...
var UpgradeSteps_name = map[int32]string{
	...
	7:  "CHECK_MASTER",
	8:  "CHECK_PRIMARIES",
	9:  "START_SOURCE_CLUSTER",
	10: "UPGRADE_MASTER",
	11: "COPY_MASTER",
	12: "UPGRADE_PRIMARIES",
	13: "START_TARGET_CLUSTER",
	14: "RECONFIGURE_PORTS",
}
...
var UpgradeSteps_value = map[string]int32{
	...
	"CHECK_MASTER":            7,
	"CHECK_PRIMARIES":         8,
	"START_SOURCE_CLUSTER":    9,
	"UPGRADE_MASTER":          10,
	"COPY_MASTER":             11,
	"UPGRADE_PRIMARIES":       12,
	"START_TARGET_CLUSTER":    13,
	"RECONFIGURE_PORTS":       14,
}
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
