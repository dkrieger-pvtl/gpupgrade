...
const (
	...
	Substep_SOURCE_RECOVERSEG       Substep = 12
	Substep_START_SOURCE_CLUSTER    Substep = 14
	Substep_START_TARGET_CLUSTER    Substep = 15
	Substep_RECONFIGURE_PORTS       Substep = 16
)
...
var Substep_name = map[int32]string{
	...
	12: "SOURCE_RECOVERSEG",
	14: "START_SOURCE_CLUSTER",
	15: "START_TARGET_CLUSTER",
	16: "RECONFIGURE_PORTS",
}
...
var Substep_value = map[string]int32{
	...
	"SOURCE_RECOVERSEG":       12,
	"START_SOURCE_CLUSTER":    14,
	"START_TARGET_CLUSTER":    15,
	"RECONFIGURE_PORTS":       16,
}
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
