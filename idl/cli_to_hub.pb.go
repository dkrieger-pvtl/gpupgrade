...
type Response struct {
	// Types that are valid to be assigned to Contents2:
	//	*Response_Initialize
	//	*Response_Execute
	//	*Response_Finalize
	//	*Response_Revert
	Contents2            isResponse_Contents2 `protobuf_oneof:"contents2"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type isResponse_Contents2 interface {
	isResponse_Contents2()
}

type Response_Initialize struct {
	Initialize *InitializeResponse `protobuf:"bytes,1,opt,name=initialize,proto3,oneof"`
}

type Response_Execute struct {
	Execute *ExecuteResponse `protobuf:"bytes,2,opt,name=execute,proto3,oneof"`
}

type Response_Finalize struct {
	Finalize *FinalizeResponse `protobuf:"bytes,3,opt,name=finalize,proto3,oneof"`
}

type Response_Revert struct {
	Revert *RevertResponse `protobuf:"bytes,4,opt,name=revert,proto3,oneof"`
}

func (*Response_Initialize) isResponse_Contents2() {}

func (*Response_Execute) isResponse_Contents2() {}

func (*Response_Finalize) isResponse_Contents2() {}

func (*Response_Revert) isResponse_Contents2() {}

func (m *Response) GetContents2() isResponse_Contents2 {
	if m != nil {
		return m.Contents2
	}
	return nil
...
func (m *Response) GetInitialize() *InitializeResponse {
	if x, ok := m.GetContents2().(*Response_Initialize); ok {
		return x.Initialize
	}
	return nil
}

func (m *Response) GetExecute() *ExecuteResponse {
	if x, ok := m.GetContents2().(*Response_Execute); ok {
		return x.Execute
	}
	return nil
}

func (m *Response) GetFinalize() *FinalizeResponse {
	if x, ok := m.GetContents2().(*Response_Finalize); ok {
		return x.Finalize
	}
	return nil
}

func (m *Response) GetRevert() *RevertResponse {
	if x, ok := m.GetContents2().(*Response_Revert); ok {
		return x.Revert
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_Execute)(nil),
		(*Response_Finalize)(nil),
		(*Response_Revert)(nil),
	}
}
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
