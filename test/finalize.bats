...
@test "reconfigure-ports substep modifies ports on the live target cluster" {
    # To avoid spinning up an entire upgrade just to test reconfigure-ports, we
    # instead create a new cluster for the test and fake the configurations to
    # point at it.
    #
