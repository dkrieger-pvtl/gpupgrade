...
func UpgradeMirrors(stateDir string, masterPort int, targetSemver semver.Version, mirrors []greenplum.SegConfig, targetRunner greenplum.Runner, useHbaHostnames bool) (err error) {
