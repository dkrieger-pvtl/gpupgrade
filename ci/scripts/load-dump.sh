...
# These are for 5 to 6 (or 6 to 6).  They should be refactored out of this file and likely replaced by our
#  migration scripts.
# They are commented out for 6 to 7 ICW testing since we want to separate out exactly what we need to drop
# in a 6to7 upgrade.
